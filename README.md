...
Release planning was complicated somewhat by due to dependencies between user-centered design activities and subsequent development.  To overcome these dependencies we performed initial development and user-centered design activities in parallel during Sprint 1.  In Sprint 2, we then refactored the working application to incorporate user centered design results.  We performed usability testing early in Sprint 3 and incorporated some of the findings into the application.  Other usability findings were added to the product backlog for priortization after the initial prototype release.
